...
La [classification NOVA](https://pubmed.ncbi.nlm.nih.gov/29218871/), développée par l'équipe de Carlos Monteiro à l'Université de São Paulo, est le cadre conceptuel le plus solide pour comprendre ce virage. Elle ne remplace pas le Nutri-Score ni les recommandations de portions, elle complète un angle mort structurel. Une méta-analyse parapluie publiée dans le [BMJ en 2024](https://pubmed.ncbi.nlm.nih.gov/38418082/), qui synthétise 45 analyses couvrant 9,8 millions de participants, a trouvé une association significative entre consommation d'ultra-transformés et 32 maladies chroniques, dont les maladies cardiovasculaires, le diabète de type 2, la dépression, certains cancers et la mortalité toutes causes.
...
**TL;DR** , La **classification NOVA** range les aliments en quatre groupes selon leur degré de transformation industrielle : NOVA 1 (aliments bruts ou peu transformés), NOVA 2 (ingrédients culinaires comme huile, sel, sucre), NOVA 3 (aliments transformés simples, pain au levain, conserves), NOVA 4 (ultra-transformés, avec additifs de synthèse et ingrédients fractionnés). Les **aliments ultra-transformés NOVA 4** représentent 33 % des calories d'un adulte français et sont associés, selon une méta-analyse BMJ 2024 couvrant 9,8 millions de participants, à un risque accru pour 32 maladies chroniques. Pour les repérer, on lit la liste d'ingrédients : plus de cinq ingrédients avec des composés fractionnés et au moins un additif cosmétique suffisent.
...
La justification scientifique de cette approche a gagné en solidité avec les études de cohorte publiées depuis 2018, notamment la cohorte [NutriNet-Santé](https://etude-nutrinet-sante.fr) en France et les cohortes américaines NHANES et EPIC en Europe. Toutes convergent : à composition nutritionnelle égale, les aliments NOVA 4 sont associés à un risque de maladies chroniques supérieur.
...
L'[Agence nationale de sécurité sanitaire de l'alimentation (ANSES)](https://www.anses.fr) a intégré la notion d'ultra-transformation dans ses travaux depuis 2019. L'avis Esteban 2024 recommande explicitement de réduire la part d'ultra-transformés dans l'alimentation française, sans fixer de seuil chiffré mais en appelant à une meilleure information du consommateur.

Le Haut Conseil de la Santé Publique a publié en 2023 un rapport qui recommande l'ajout d'un signal NOVA ou équivalent aux côtés du [Nutri-Score](/fr/blog/nutri-score-limites-critique/) sur les emballages. Cette recommandation n'a pas encore été mise en œuvre législativement, mais elle structure le discours officiel.

Les pouvoirs publics recommandent pour l'instant la démarche indirecte : « une alimentation variée, principalement à base de produits bruts ou peu transformés, cuisinée à la maison quand c'est possible ». Cette formulation est dans les [repères de Santé publique France](https://www.mangerbouger.fr/l-essentiel/les-recommandations-sur-l-alimentation-l-activite-physique-et-la-sedentarite) depuis la révision PNNS 4 de 2019.

## Comment NutriDécrypte intègre NOVA

L'[algorithme NutriDécrypte](/fr/methodology/) donne à la classification NOVA un poids de 25 % dans la note finale, au même niveau que le Nutri-Score. Le calcul est simple : NOVA 1 contribue 95 points sur 100 à l'axe, NOVA 2 contribue 82, NOVA 3 contribue 55, NOVA 4 contribue 20. Cette pondération est publique et reproductible à partir de nos [fiches produits](/fr/classement/).
...
1. [Monteiro et al., classification NOVA, publication méthodologique, 2018](https://pubmed.ncbi.nlm.nih.gov/29218871/) , référence fondatrice du cadre conceptuel.
2. [BMJ, méta-analyse parapluie ultra-transformés et 32 maladies chroniques, 2024](https://pubmed.ncbi.nlm.nih.gov/38418082/) , synthèse de 45 méta-analyses, 9,8 millions de participants.
3. [Hall et al., essai clinique randomisé NIH sur NOVA 4 et prise alimentaire, Cell Metabolism 2019](https://pubmed.ncbi.nlm.nih.gov/31105044/) , étude contrôlée pivot.
4. [NutriNet-Santé, émulsifiants et risque de cancer, PLoS Medicine 2023](https://pubmed.ncbi.nlm.nih.gov/37696792/) , cohorte française de référence.
5. [NutriNet-Santé, présentation de la cohorte](https://etude-nutrinet-sante.fr) , site officiel de l'étude française.
6. [ANSES, portail scientifique et avis Esteban 2024](https://www.anses.fr) , évaluation française de l'exposition et des risques.
7. [Santé publique France, repères PNNS 4 et recommandations alimentation](https://www.mangerbouger.fr/l-essentiel/les-recommandations-sur-l-alimentation-l-activite-physique-et-la-sedentarite) , base officielle des recommandations.
