...
**TL;DR** , Le **Nutri-Score** est un outil utile mais incomplet. Il présente cinq angles morts majeurs : il ignore l'ultra-transformation (un produit NOVA 4 peut obtenir B), il ne pénalise pas clairement les édulcorants intenses, il ne tient pas compte de la taille de portion vendue, il récompense la reformulation cosmétique (ajout de fibres, retrait de sel) sans changer la matrice alimentaire, et il est pensé pour l'arbitrage intra-catégorie, pas pour l'équilibre global du caddie. Pour choisir vraiment mieux, il faut croiser Nutri-Score, classification NOVA, audit des additifs et lecture des allégations marketing.
...
Le problème est devenu un enjeu de santé publique. La [classification NOVA](/fr/blog/ultra-transforme-nova-classification/), développée par l'équipe de Carlos Monteiro à l'Université de São Paulo, classe les aliments en quatre groupes selon leur degré de transformation : NOVA 1 (aliment brut), NOVA 2 (ingrédient culinaire), NOVA 3 (aliment transformé simple, conserve, pain au levain), NOVA 4 (ultra-transformé, qui cumule additifs de synthèse, ingrédients fractionnés, procédés industriels). L'ultra-transformation NOVA 4 est associée, dans une méta-analyse du [BMJ publiée en 2024](https://pubmed.ncbi.nlm.nih.gov/38418082/) couvrant 9,8 millions de participants, à une augmentation du risque de 32 maladies chroniques (cardiovasculaires, métaboliques, dépression, cancer).

En clinique, je vois des patients qui suivent scrupuleusement les recommandations « privilégier les A et B » et continuent à consommer 60 % d'ultra-transformés. Le Nutri-Score est utile pour arbitrer entre deux yaourts, mais il ne signale pas que le yaourt choisi contient quatre additifs et trois arômes. C'est précisément pour combler cette lacune que l'[algorithme NutriDécrypte](/fr/methodology/) intègre un axe NOVA (25 % de la note) et un axe additifs (20 %), en plus du Nutri-Score (25 %).
...
C'est la limite la plus méconnue, et peut-être la plus importante à comprendre. Le Nutri-Score a été construit comme un **outil d'arbitrage intra-catégorie** : il sert à choisir le meilleur yaourt parmi une étagère de yaourts, la meilleure céréale parmi une gamme de céréales. Ses créateurs insistent sur ce point dans [leurs publications de référence](https://pubmed.ncbi.nlm.nih.gov/30340025/).
...
L'[Agence nationale de sécurité sanitaire de l'alimentation (ANSES)](https://www.anses.fr) soutient publiquement le Nutri-Score et recommande son affichage obligatoire en UE depuis son avis de 2022. Mais dans le même avis, elle rappelle que l'évaluation nutritionnelle d'un produit ne peut se réduire à un score synthétique et doit intégrer plusieurs dimensions : la composition en ingrédients, le degré de transformation, la présence d'additifs, la taille des portions vendues.
...
- **Indice de risque additifs** (20 %) , croisement avec notre [base des 400 additifs E](/fr/encyclopedie/) et les avis ANSES/EFSA
...
La [méthodologie complète](/fr/methodology/) est publique et reproductible : mêmes ingrédients, même note, toujours. Aucun paramètre n'est ajusté à la main.
...
Pour tester ces trois réflexes sur des produits concrets, tu peux parcourir notre [classement complet](/fr/classement/) qui compare Nutri-Score officiel et note NutriDécrypte côte à côte sur plus de 700 produits du marché français.
...
1. [Santé publique France, dossier Nutri-Score](https://www.santepubliquefrance.fr) , pilotage scientifique et suivi du déploiement en France.
2. [Étude BMJ Open sur l'impact du Nutri-Score sur les choix des consommateurs, 2022](https://bmjopen.bmj.com/content/12/10/e061979) , publication de référence.
3. [Organisation mondiale de la Santé, recommandation sur les édulcorants non sucrés, mai 2023](https://www.who.int/news/item/15-05-2023-who-advises-not-to-use-non-sugar-sweeteners-for-weight-control-in-newly-released-guideline) , guideline officiel.
4. [OMS, évaluation de l'aspartame par le CIRC et le JECFA, juillet 2023](https://www.who.int/fr/news/item/14-07-2023-aspartame-hazard-and-risk-assessment-results-released) , communiqué officiel.
5. [BMJ Evidence-Based Nutrition, NutriNet-Santé sur édulcorants et risque cardiovasculaire, 2022](https://pubmed.ncbi.nlm.nih.gov/36101788/) , cohorte française de référence.
6. [BMJ, méta-analyse ultra-transformés et 32 maladies chroniques, 2024](https://pubmed.ncbi.nlm.nih.gov/38418082/) , étude parapluie la plus large.
7. [Julia et Hercberg, publication de référence sur la modélisation Nutri-Score, European Journal of Clinical Nutrition](https://pubmed.ncbi.nlm.nih.gov/30340025/) , méthodologie scientifique originale.
8. [ANSES, portail scientifique sur la nutrition et les additifs](https://www.anses.fr) , avis 2022 sur Nutri-Score et reformulation.
