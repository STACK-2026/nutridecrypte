...
L'**indice TOTOX** est calculé selon la formule :
...
1. **Privilégie la forme triglycérides (TG ou rTG)** par rapport aux ethyl esters : la différence d'absorption justifie le surcoût.
2. **Vérifie la quantité réelle d'EPA et DHA** par capsule, pas le poids total d'huile : c'est ce qui compte vraiment.
3. **Exige la transparence** : certification de pureté (IFOS, GOED), TOTOX publié, source identifiée. Si la marque ne communique pas, change de marque.
