...
description: Interdit dans l'alimentaire UE depuis 2022, le E171 reste dans tes médicaments
  et dentifrices. État des lieux 2026, chiffres ANSES, batailles juridiques.
draft: false
...
> "Considérant toutes les preuves scientifiques disponibles, y compris les nouvelles données sur les nanoparticules, le Panel n'a pas pu exclure la génotoxicité du E171 et donc ne peut plus le considérer comme sûr en tant qu'additif alimentaire."
...
Télécharge gratuitement **NutriDecrypte** sur App Store et Google Play, ou consulte la base en ligne sur **nutridecrypte.fr**.
...
- [Céréales petit-déjeuner : le top 10 du pire, le top 10 du meilleur (notes NutriDecrypte)](/fr/blog/petit-dejeuner-industriel-pire-meilleur/)
