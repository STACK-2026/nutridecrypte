...
author: "Sarah Keller"
category: "additifs"
image: https://images.unsplash.com/photo-1606787366850-de6330128bfc?w=1200&h=630&fit=crop&crop=center&q=80
imageAlt: "Rayon de biscuits, chips et produits gras emballés susceptibles de contenir du BHA E320 et du BHT E321"
keywords: "bha bht e320 e321 danger, e320 antioxydant, e321 bht, antioxydant synthèse aliment, BHA cancérogène EFSA"
lang: fr
lastReviewed: 2026-06-16
reviewedBy: "Sarah Keller, diététicienne-nutritionniste"
tags:
- bha bht e320 e321 danger
tldr: "Le BHA (E320, hydroxyanisole butylé) et le BHT (E321, hydroxytoluène butylé) sont des antioxydants de synthèse qui empêchent les graisses de rancir dans les chips, biscuits, bouillons, chewing-gums et plats gras. L'EFSA les a réévalués et a fixé une dose journalière admissible de 1 mg par kilo de poids corporel pour le BHA et de 0,25 mg par kilo pour le BHT. Le CIRC classe le BHA comme cancérogène possible pour l'homme (groupe 2B) sur la base d'effets observés chez l'animal, sans preuve établie chez l'humain aux doses alimentaires. Le vrai signal n'est pas une toxicité prouvée, mais le fait que leur présence trahit presque toujours un produit ultra-transformé et gras."
faq:
  - q: "Le BHA (E320) et le BHT (E321) sont-ils dangereux pour la santé ?"
...
- **Apprends à décoder une étiquette complète.** Repérer un seul additif ne suffit pas ; c'est l'ensemble qui compte, comme expliqué dans notre [guide pour lire une liste d'ingrédients](/fr/blog/comment-lire-liste-ingredients-guide/).
...
1. Pour la **population générale**, aux doses d'usage, le BHA et le BHT ne sont pas un danger établi selon les agences. Pas de panique devant un paquet de chips occasionnel.
2. Le **BHA est classé cancérogène possible** par le Centre international de recherche sur le cancer, sur la base d'effets chez l'animal. Ce signal invite à la prudence chez les gros consommateurs de produits gras industriels, sans constituer une preuve de danger chez l'humain.
3. Leur présence est surtout un **marqueur d'ultra-transformation**. Les limiter revient à limiter une catégorie d'aliments dont la réduction est bénéfique pour bien d'autres raisons.
...
- [Sulfites (E220) : où ils se cachent et leurs effets](/fr/blog/sulfites-e220-dangers-vin-aliments/)
